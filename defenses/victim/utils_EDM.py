from defenses.models.cifar.wresnet import WideResNet
import torch.nn as nn
from defenses.models.ml_models import LeNet5
from defenses.models.ml_models import Conv3
...
model_dict = {
    ...
    "conv3": Conv3,
    "lenet": LeNet5,
    "wres16-4": partial(WideResNet, 16, widen_factor=4 ,num_classes=10),
}
